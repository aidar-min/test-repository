...
//данный тест не подошел т.к. просто перечисляется пункты меню, но не выполнит поставленной задачи по проверке пунктов меню в случае удаления либо добавления пункта меню.